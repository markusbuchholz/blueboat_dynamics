...
// g++ mpc_blue_dyn.cpp -o t -I/usr/include/eigen3 -I/usr/include/python3.12 -I/usr/lib/python3/dist-packages/numpy/core/include -lpython3.12
...
// MPC parameters
int horizon = 20; // Increased Prediction horizon
float Q = 0.0001f;  // Increased State cost
...
int main() {
    ...
    plot2D2D(time, psi, psi_desired, "MPC ASV: Heading (Psi) vs Time", "Time (s)", "Heading (rad)");
}
